...
class BankId {
    ...
    authenticate(personalNumber, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const result = yield this.client.AuthenticateAsync(params);
    ...
    sign(personalNumber, userVisibleData, userNonVisibleData, options) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.init();
            if (userVisibleData.length > 40 * 1000) {
                //TODO add error message
                throw new BankIdError("CLIENT_ERROR", "User visible data exceeds 40k chars");
            }
            const base64nonVisibleData = new Buffer(userNonVisibleData).toString("base64");
            if (base64nonVisibleData.length > 200 * 1000) {
                //TODO add error message
                throw new BankIdError("CLIENT_ERROR", "User non-visible data exceeds 200k chars");
            }
            const params = Object.assign({}, {
                personalNumber: personalNumber,
            ...
            try {
                //soap methods are pascal cased bruuh :(
                const result = yield this.client.SignAsync(params);
                return result.orderRef;
            }
            catch (err) {
                throw new BankIdError(err);
